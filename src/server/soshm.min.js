function soshm(e) {
  function t(o) { if (i[o]) return i[o].exports; var s = i[o] = { exports: {}, id: o, loaded: !1 }; return e[o].call(s.exports, s, s.exports, t), s.loaded = !0, s.exports }
  var i = {};
  ...
  function o(e, t) {
    for (var i = u.querySelectorAll(e), o = 0, r = i.length; o < r; o++) {
      ...
      if ("initialized" !== c) {
        var d = m(a.dataset);
        d.sites && (d.sites = d.sites.split(",")), t = m({}, E, d, t);
        var p = n(t.sites);
        a.insertAdjacentHTML("beforeend", p), a.setAttribute("sosh-status", "initialized"), a.classList.add("soshm"),
          function(e) {
            h(a, ".soshm-item", "click", function(t) {
  ...
  function n(e, t) {
    for (var i = "", t = "number" === r(t) && 0 !== t ? t : 0, o = 0, s = e.length; o < s; o++) {
      t && o % t === 0 && (i += '<div class="soshm-group group' + (o / t + 1) + '">');
      var n = e[o],
        a = l[n];
      a ? i += C.replace(/\{\{site\}\}/g, n).replace(/\{\{icon\}\}/g, a.icon).replace(/\{\{name\}\}/g, a.name) : console.warn("site [" + n + "] not exist."), !t || o % t !== t - 1 && o !== s - 1 || (i += "</div>")
    }
    return i
  }

  function r(e) { return null === e ? "null" : void 0 === typeof e ? "undefined" : Object.prototype.toString.call(e).match(/\s([a-zA-Z]+)/)[1].toLowerCase() }

  function a(e, t) { var i = []; for (var o in t) i.push(o + "=" + t[o]); return e + (e.indexOf("?") !== -1 ? "&" : "?") + i.join("&") }

  function A(e) { for (var t = location.search.substring(1), i = t.split("&"), o = i.length, s = 0; s < o; s++) { var n = i[s].split("="); if (decodeURIComponent(n[0]) === e) return decodeURIComponent(n[1]) } }

  function c(e, t) {
    var i = u.createElement("script");
    i.src = e, i.onload = onreadystatechange = function() { this.readyState && "load" !== this.readyState && "complete" !== this.readyState || (t && t(), i.onload = onreadystatechange, i.parentNode.removeChild(i)) }, g.appendChild(i)
  }
  ...
  function d(e) {
    if (f.isIOS) window.location.href = e;
      ...
      t.style.display = "none", t.src = e, g.appendChild(t), setTimeout(function() { t && t.parentNode && t.parentNode.removeChild(t) }, 2e3)
    }
  }
  i(7);
  var h = i(5),
    ...
    g = u.body,
    b = !1;
  (f.isIOS && f.ucBrowserVersion >= 10.2 || f.isAndroid && f.ucBrowserVersion >= 9.7 || f.qqBrowserVersion >= 5.4) && (b = !0);
  var w = { weibo: ["kSinaWeibo", "SinaWeibo", 11], weixin: ["kWeixin", "WechatFriends", 1], weixintimeline: ["kWeixinFriend", "WechatTimeline", 8], qq: ["kQQ", "QQ", 4], qzone: ["kQZone", "Qzone", 3] },
  ...
  e.exports = function() {
    ...
    return e.toString = function() {
      ...
      for (var o = {}, s = 0; s < this.length; s++) { var n = this[s][0]; "number" == typeof n && (o[n] = !0) }
      for (s = 0; s < t.length; s++) { var r = t[s]; "number" == typeof r[0] && o[r[0]] || (i && !r[2] ? r[2] = i : i && (r[2] = "(" + r[2] + ") and (" + i + ")"), e.push(r)) }
    }, e
  }
}, function(e, t) {
  function i(e, t) {
  ...
  function o(e, t, i, o, n) { var r = s.apply(this, arguments); return e.addEventListener(i, r, n), { destroy: function() { e.removeEventListener(i, r, n) } } }

  function s(e, t, i, o) { return function(i) { i.delegateTarget = n(i.target, t), i.delegateTarget && o.call(e, i) } }
  var n = i(4);
  e.exports = o
}, function(e, t, i) {
  function o(e, t) {
    for (var i = 0; i < e.length; i++) {
      var o = e[i],
        s = p[o.id];
      if (s) { s.refs++; for (var n = 0; n < s.parts.length; n++) s.parts[n](o.parts[n]); for (; n < o.parts.length; n++) s.parts.push(c(o.parts[n], t)) } else {
  ...
  function s(e) {
    for (var t = [], i = {}, o = 0; o < e.length; o++) {
      var s = e[o],
        ...
        a = s[2],
        A = s[3],
        c = { css: r, media: a, sourceMap: A };
      i[n] ? i[n].parts.push(c) : t.push(i[n] = { id: n, parts: [c] })
    }
    return t
  }
  ...
  function n(e, t) {
    var i = u(),
      o = w[w.length - 1];
    if ("top" === e.insertAt) o ? o.nextSibling ? i.insertBefore(t, o.nextSibling) : i.appendChild(t) : i.insertBefore(t, i.firstChild), w.push(t);
    else {
  ...
  function a(e) { var t = document.createElement("style"); return t.type = "text/css", n(e, t), t }

  function A(e) { var t = document.createElement("link"); return t.rel = "stylesheet", n(e, t), t }

  function c(e, t) {
    var i, o, s;
    if (t.singleton) {
      var n = b++;
      i = g || (g = a(t)), o = d.bind(null, i, n, !1), s = d.bind(null, i, n, !0)
    } else e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (i = A(t), o = m.bind(null, i), s = function() { r(i), i.href && URL.revokeObjectURL(i.href) }) : (i = a(t), o = h.bind(null, i), s = function() { r(i) });
    return o(e),
      function(t) {
        if (t) {
  ...
  var p = {},
    l = function(e) { var t; return function() { return "undefined" == typeof t && (t = e.apply(this, arguments)), t } },
    f = l(function() { return /msie [6-9]\b/.test(window.navigator.userAgent.toLowerCase()) }),
    u = l(function() { return document.head || document.getElementsByTagName("head")[0] }),
    g = null,
    b = 0,
    w = [];
  ...
  var C = function() { var e = []; return function(t, i) { return e[t] = i, e.filter(Boolean).join("\n") } }()
}, function(e, t, i) {
  var o = i(2);
  "string" == typeof o && (o = [
    [e.id, o, ""]
  ...
  var i = {
    ...
    encode: function(e) {
      var t, o, s, n, r, a, A, c = "",
        d = 0;
      for (e = i._utf8_encode(e); d < e.length;) t = e.charCodeAt(d++), o = e.charCodeAt(d++), s = e.charCodeAt(d++), n = t >> 2, r = (3 & t) << 4 | o >> 4, a = (15 & o) << 2 | s >> 6, A = 63 & s, isNaN(o) ? a = A = 64 : isNaN(s) && (A = 64), c = c + this._keyStr.charAt(n) + this._keyStr.charAt(r) + this._keyStr.charAt(a) + this._keyStr.charAt(A);
      return c
    },
    decode: function(e) {
      var t, o, s, n, r, a, A, c = "",
        d = 0;
      for (e = e.replace(/[^A-Za-z0-9\+\/\=]/g, ""); d < e.length;) n = this._keyStr.indexOf(e.charAt(d++)), r = this._keyStr.indexOf(e.charAt(d++)), a = this._keyStr.indexOf(e.charAt(d++)), A = this._keyStr.indexOf(e.charAt(d++)), t = n << 2 | r >> 4, o = (15 & r) << 4 | a >> 2, s = (3 & a) << 6 | A, c += String.fromCharCode(t), 64 != a && (c += String.fromCharCode(o)), 64 != A && (c += String.fromCharCode(s));
