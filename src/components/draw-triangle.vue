...
export default {
  ...
  mounted:function () {
    ...
    var oneX = this.canvasWidth / 2;
    var oneY = this.canvasHeight / 4;
    var tHeight = this.canvasWidth / 1.5;
    var twoX = oneX - tHeight *  0.57735026918963;
    var twoY = oneY + tHeight;
    var threeX = oneX + tHeight *  0.57735026918963;
    var threeY = oneY + tHeight;
    var pointArr = [];
    this.canvas = ctx;
